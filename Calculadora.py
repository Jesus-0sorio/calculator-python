...
boton_eliminar = Button(ventana, text = u"\u232B", width = 5, height = 20, command = lambda: elimiar())
boton_paretensis1 = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton("("))
boton_paretensis2 = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton(")"))
...
boton_paretensis1.grid(row = 1, column = 1, padx = 5, pady = 5)
boton_paretensis2.grid(row = 1, column = 2, padx = 5, pady = 5)
...
#Columna 5
boton_eliminar.grid(row = 1, rowspan = 5, column = 5, padx = 5, pady = 5)
ventana.mainloop()